...
<div class="divTable minimalistBlack">
    ...
    <div class="divTableBody">
        ...
        %>
        <div class="divTableRow">
            <div class="divTableCell"><%=CmmUtil.nvl(rDTO.getMovieRank())%></div>
            <div class="divTableCell"><%=CmmUtil.nvl(rDTO.getMovieNm())%></div>
            <div class="divTableCell"><%=CmmUtil.nvl(rDTO.getScore())%></div>
            <div class="divTableCell"><%=CmmUtil.nvl(rDTO.getOpenDay())%></div>
        </div>
        <%
            }
        %>
