 ...
 * 스프링 프레임워크는 기본으`로 logback을 채택해서 로그 처리함
 * */
@Slf4j
@RequestMapping(value = "/notice") // /notice로 시작하는 URL 전부 NoticeController 에서 처리하기 위하여 어노테이션 추가
...
//        }
     ...
     * 게시판 작성 페이지 이동
     * <p>
     * 이 함수는 단순 게시판 작성 페이지로 접근만을 위해 만듬
     * <p>
