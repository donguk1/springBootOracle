...
public class NetworkUtil {
    ...
    /**
     * GET 방식으로 OpenAIP 호출하기(전송할 헤더값이 존재하지 않는 경우 사용<p>
    ...
    /**
     * OpenAPI URL에 접속하기<p>
     * 이 함수는 NetworkUtil 에서만 사용하기에 접근 제한자 private 선언<p>
     * 외부 자바 파일에서 호출 불가
     *
     * @param apiUrl 호출할 OpenAPI URL 주소
     */
    ...
    /**
     * OpenAPI 호출 후, 받은 결과를 문자열로 변환하기<p>
     * 이 함수는 NetworkUtil에서만 사용하기에 접근 제한자를 private로 선언<p>
     * 외부 자바 파일에서 호출 불가
     *
     * @param body 읽은 결과값
     */
